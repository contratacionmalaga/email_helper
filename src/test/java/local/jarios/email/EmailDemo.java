...
public final class EmailDemo {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      notifier.notifyError(
          ex, contexto, cargarPropertiesSmtpValidas() // o SMTP alternativo
          );
  ...
  private static Properties cargarPropertiesSmtpValidas() {
    ...
    Map<String, String> propMap = Map.of(SMTP_PASSWORD, getRequiredEnv("SMTP_PASSWORD"));
  ...
  private static Properties cargarPropertiesSmtpErroneas() {
    ...
    Map<String, String> propMap =
        Map.of(SMTP_PASSWORD, System.getenv().getOrDefault("SMTP_PASSWORD_INVALID", "PRUEBA"));
  ...
  private static EmailData construirEmailData() throws UnknownHostException {
    ...
    String subject = EmailHelper.getAsunto("email-helper", "VERSION_PRUEBA", hostname, true);
