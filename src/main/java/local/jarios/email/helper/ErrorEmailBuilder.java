...
public final class ErrorEmailBuilder {
   ...
   */
  public static EmailData build(Throwable ex, String contexto, String from, String to) {
    return build(ex, contexto, from, to, DEFAULT_ERROR_SUBJECT, DEFAULT_STACKTRACE_MAX_LENGTH);
  }
  ...
  public static EmailData build(
    ...
    String stackTrace = truncate(ExceptionUtils.stackTraceToString(error), maxStackTraceLength);
