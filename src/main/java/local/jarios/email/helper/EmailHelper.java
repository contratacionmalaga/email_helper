...
/**
 * Helper responsable de construir el contenido HTML y el asunto de los correos electrónicos.
 *
 * <p>Esta clase no realiza logging en el flujo normal. El logging debe hacerse en la capa de
...
public final class EmailHelper {
  ...
  public static String getPieBody() {
    return "<div class='footer'><p>Reporte generado automáticamente.</p></div>"
        + "</div>"
        + "</body>";
  }
  ...
  public static String getAsunto(
      String appName, String appVersion, String equipo, boolean success) {
  ...
  private static String construirCuerpo(String[][] filas, boolean isExcepcion) {
    ...
    cuerpo.append(getPieTable()).append(getPieBody()).append(getPieHtml());
