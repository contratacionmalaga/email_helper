 ...
 *
 * <p>Proporciona funciones para obtener el nombre del host, imprimir objetos, calcular tiempos de
 * ejecución y formatear fechas.
 *
 * @author Juan Antonio
 */
public final class TextHelper {
  ...
  public static String recortar(String cadena, int tamano) {
    ...
    // Se verifica primero que la longitud sea mayor a tamano para evitar
