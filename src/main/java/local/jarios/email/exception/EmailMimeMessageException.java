 ...
 * @since 13/06/2025
 */
public class EmailMimeMessageException extends RuntimeException {
     ...
     */
    public EmailMimeMessageException(String message) {
        super(message);
    }
     ...
     */
    public EmailMimeMessageException(String message, Throwable cause) {
        super(message, cause);
    }
}
