 ...
 * @since 13/06/2025
 */
public class EmailSessionFactoryException extends RuntimeException {
     ...
     */
    public EmailSessionFactoryException(String message) {
        super(message);
    }
     ...
     */
    public EmailSessionFactoryException(String message, Throwable cause) {
        super(message, cause);
    }
}
