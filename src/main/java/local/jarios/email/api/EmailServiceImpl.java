 ...
 *
 * <ul>
 *   <li>Orquesta el envío del correo
 *   <li>Realiza logging a nivel de negocio
 *   <li>No expone información sensible
 * </ul>
 */
@Slf4j
public class EmailServiceImpl implements EmailService {
  ...
  public void sendEmail(Properties props, EmailData data) throws EmailException {
    ...
    try {
      ...
      throw new EmailException("Error inesperado durante el envío del correo electrónico.", ex);
    }
  }
  ...
  private Message createMimeMessage(Session session, EmailData data) throws EmailException {
    ...
    try {
      ...
      throw new EmailException("Error creando el mensaje de correo electrónico.", ex);
    }
  }
