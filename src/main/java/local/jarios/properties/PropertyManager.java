...
public final class PropertyManager {
    ...
    /**
     * Imprime un objeto Properties.
     *
     * @param properties El objeto a imprimir
     */
    private static void imprimirProperties(Properties properties) {
        properties.stringPropertyNames()
                .stream()
                .sorted()
                .forEach(key -> imprimirPropiedad(key, properties.getProperty(key)));
    }
